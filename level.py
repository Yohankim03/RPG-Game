...
class Level:
    def __init__(self):
        ...
        self.isalive = True 
        self.player_death = pygame.mixer.Sound("audio/death.wav")
    ...
    def damage_player(self, amount, attack_type):
        if self.player.vulnerable and self.player.stats["health"] > 0:
    ...
    def toggle_death_screen(self):
        self.screen.display_death_screen()
...
class YsortCameraGroup(pygame.sprite.Group):
    ...
    def custom_draw(self, player):
        # Getting the offest (setup for depth)
        ...
        # Draws all of the elements (some with depth)
